...
from MainCode.parser import startParse
from MainCode.core.database import Database
from MainCode.core.table import Table
            ...
            if commandline=='test':
                ...
                for commandline in commandlines:
                    ...
                    try:
                        ...
                        if result == 'exit':
                            print ('Exit successfully! See you next time!')
                            sys.exit(0)
                            return
